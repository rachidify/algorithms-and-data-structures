...
func (suite *DoublyLinkedListTestSuite) SetupTest() {
	suite.list = &linkedlist.DoublyLinkedList{}
}

func (suite *DoublyLinkedListTestSuite) TestPushFront() {
	suite.list.PushFront("A")

	assert.Equal(suite.T(), "A", suite.list.TopFront())
}

func (suite *DoublyLinkedListTestSuite) TestPopFront() {
...
func (suite *DoublyLinkedListTestSuite) TestPushBack() {
	suite.list.PushFront("A")
	suite.list.PushBack("B")
	assert.Equal(suite.T(), "B", suite.list.TopBack())
}

func (suite *DoublyLinkedListTestSuite) TestPopBack() {
	assert.EqualError(suite.T(), suite.list.PopFront(), "empty list")
...
func (suite *DoublyLinkedListTestSuite) TestEmpty() {
...
func (suite *DoublyLinkedListTestSuite) TestFind() {
...
func (suite *DoublyLinkedListTestSuite) TestErase() {
	assert.EqualError(suite.T(), suite.list.PopFront(), "empty list")
